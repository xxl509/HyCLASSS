...
%   $Revision: 1.1.6.11 $  $Date: 2011/05/13 18:14:01 $ 
...
[x,Lx,y,is2sig,win] = validateinputs(x,win,nfft);
...
P = Xx.*conj(Xx)/U;      % Auto spectrum. conj是求复数的共轭
if is2sig,
    P = Xx.*conj(Yy)/U;  % Cross spectrum.
end

%--------------------------------------------------------------------------
function [x,Lx,y,is2sig,win] = validateinputs(x,win,nfft)
