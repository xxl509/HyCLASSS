...
%   $Revision: 1.1.6.10 $  $Date: 2011/05/13 18:08:26 $ 
...
% There can still be some minor round off errors 舍入误差 in the frequency grid.  
...
isNPTSodd = false;
if rem(NPTS,2),   %rem(x,y):求整除x/y的余数        mod(x,y):求模
    isNPTSodd = true;
end
